...
const Footer = () => {
  return (
    <div className='rounded-div mt-8 pt-8 text-primary mb-2'>
      <div className='grid md:grid-cols-2'>
        ...
        <div className='w-full flex justify-end'>
            <div className='w-full md:w-[300px] py-4 relative'>
                ...
                <div className='py-4'>
                    <form>
                        <input className='bg-primary border-input p-2 mr-2 w-full shadow-xl rounded-2xl md:w-auto' type="email" placeholder='Enter your email'/>
                        <button className='bg-button text-btnText px-4 p-2 w-full shadow-xl rounded-2xl hover:shadow-2xl md:w-auto my-2'>Sign Up</button>
                    </form>
                </div>
